...
## Scope
This directory contains all project documentation organized by domain. Each subdirectory focuses on a specific aspect of the Slytube project.

## File Index
- [architecture/](architecture/) - System architecture and design decisions
- [backend/](backend/) - Backend implementation details and APIs
